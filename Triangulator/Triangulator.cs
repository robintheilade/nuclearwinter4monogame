	...
	public static class Triangulator
	{
		...
		public static WindingOrder DetermineWindingOrder(Vector2[] vertices)
		{
            ...
            for( int i = 1; i < vertices.Length; i++ )
            {
                ...
                float scalarProduct = ( start.X * end.Y ) - ( end.X * start.Y );
            ...
            Vector2 end2 = vertices[0];
            area += ( start.X * end2.Y ) - ( end2.X * start.Y );
            
            return (area < 0) ? WindingOrder.Clockwise : WindingOrder.CounterClockwise;
		}
