...
namespace NuclearWinter.UI
{
    public class Scrollbar : Widget
    {
        ...
        //----------------------------------------------------------------------
        public Scrollbar(Screen screen)
        : base(screen)
        {
        ...
        //----------------------------------------------------------------------
        public void DoLayout(Rectangle rectangle, int contentHeight)
        {
            ...
            Max = Math.Max(0, contentHeight - ScrollRect.Height);
            ...
            miScrollbarHeight = Math.Max(10, (int)((ScrollRect.Height - 20) / ((float)contentHeight / (ScrollRect.Height - 20))));
